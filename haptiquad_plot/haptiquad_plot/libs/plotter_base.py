...
class PlotterBase(Node, tk.Tk):
	...
	def __init__(self, node_name):
		...
		save_icon_path = f"{get_package_share_directory('haptiquad_plot')}/res/save_icon.png"
		pause_icon_path = f"{get_package_share_directory('haptiquad_plot')}/res/pause_icon.png"
